...
function addAwakeTimeAtNight1 () {
	console.log('kör AwakeTimeAtNight1');
	var awakeHours = 0;
	var awakeMin = 0;
	var awakeTotalMin = 0;
	var awakeTimeAtNightList = document.querySelectorAll('#awakeTimeAtNight #night1 .addInputContainer input');
